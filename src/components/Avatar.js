  ...
  render() {
    ...
    return (
      <Styles>
        ...
        > */}
        <div
          style={{ height: "calc(100vh - 240px)", border: "1px solid white" }}
        >
          <div className="row" data-aos="animateFadeInUp">
            <div className="column" style={{ border: "1px solid white" }}>
              <div>
            ...
            <div className="column" style={{ border: "1px solid white" }}>
              <div>
                <img className="img2" src={Puffin} alt="" />
              </div>
            </div>
            <div className="column" style={{ border: "1px solid white" }}>
              <div>
